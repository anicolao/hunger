...
## A correction appends an event and updates the episode projection

![A correction appends an event and updates the episode projection](./screenshots/001-corrected-episode-phone-darwin.png)
